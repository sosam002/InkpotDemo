...
// ~ReturnValue = ExRaidMsg("헤시타거스가 [호권]을 시전합니다." )
// 레이드 알람     헤시타거스가 "호권"을 시전합니다.
...
~ReturnValue = ExTutorial(" [토벌완료] 버튼을 누르고 전리품을 획득하세요.", "[토벌완료] 버튼", "[토벌완료]버튼 누르고 전리품 획득")
